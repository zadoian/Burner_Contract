...
/// @custom:security-contact info@burner.me
contract burner is ERC20, ERC20Permit, Ownable {
    address internal SHIBA_BURN_ADDRESS = 0xdEAD000000000000000042069420694206942069;
    constructor(address _address) ERC20("burner", "FLAME") ERC20Permit("burner") Ownable(_address) {
